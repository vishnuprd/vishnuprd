...
---
  ...
  Currently Exploring**
⚡ T3 Stack for modern, type-safe web applications
...
---
 ...
 Working Style
• Strong advocate of clean architecture, reusable components, and scalable system design
• Experienced in Agile environments with close collaboration across design, backend, and QA teams
• Detail-oriented, fast learner, and proactive problem solver with quick adaptability to new technologies
...
Open to
Full-time full-stack roles, freelance projects, and professional collaborations.
